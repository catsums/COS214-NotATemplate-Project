...
void WarEngine::handleWar(int i) 
{
  ...
  switch (action)
  {
    ...
    case 1: //land attack
    {
      ...
      cout<<"Commencing Land Attack"<<endl;
      b->commenceBattle();
    } 
    break;
    case 2: //sea attack
    {
      ...
      Battle* b = new Battle(countryArr[i], target, theatre);
      cout<<"Commencing Sea Attack"<<endl;
      b->commenceBattle();
    }
    break;
    case 3: //air attack
    {
      ...
      Battle* b = new Battle(countryArr[i], target, theatre);
      cout<<"Commencing Air Attack"<<endl;
      b->commenceBattle();
    }
    break;
    case 4: //Recruit troops
    {
      ...
      cout << countryArr[i]->getName() << " is building artillery. (Factory Method)(Abstract Factory)" << endl;
      countryArr[i]->buildArtillery();
